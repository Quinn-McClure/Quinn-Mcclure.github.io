        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            <section>
                ...
                <p className="text-base py-2 text-text-muted">
                    ...
                    working with an individual that can tailor and personalize what you want to be uniquely you. With this too you know exactly where your money is going, to support a person not a CEO or
                    machine. You can also take solace in the fact that you aren't contributing to the adverse effects on the environment that AI is contributing to at a rapid rate. 
                </p>
            </section>
            ...
            <section>
                ...
                <p className="text-base py-2 text-text-muted">
                    Expanding upon my passions, I have been a building my skills as a writer. I would love to expand writing into a capacity that I can do full time. Currently I have
