        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    and a minor in Environmental Studies. While in school, I developed a deep love for both writing and
                    design alongside my computer science school work. In my free time, I would write and publish movie reviews online (which I still do) and I also 
                    worked at the on-campus recreation center as a graphic designer for a couple of years.
                        </p>
                        <p className="text-base text-text-muted">
                        After my graduation in December 2024, I worked for startup for a few months before getting laid off along
                    ...
                    a big move to Minneapolis. All these life changes at once felt like quite a lot and once I got settled into a new city, I tried and tried to break back
                    into tech. This proved even more difficult than when I was applying as a student since this was a situation that most people were in, so competition was fierce. 
                    Unemployment was high and hundreds applied to job postings. So after almost a year of doing that, I tried out something different.
                        </p>
                        <p className="text-base text-text-muted">
                    ...
                    options. That is where this website comes in. This is a site to showcase my multifaceted abilities and to not only go after
